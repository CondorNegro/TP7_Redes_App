...
#Nombre comun: strapi.sergiomartin.tp7
...
cd ..
cd ..
sudo docker exec -it src_h11_1 sh -c "update-ca-certificates"
sudo docker exec -it src_h11_1 sh -c "dpkg-reconfigure ca-certificates"
#Yes
#Certificates: 1
sudo docker exec -it src_h11_1 sh -c "curl https://strapi.sergiomartin.tp7"
sudo docker exec -it src_h13_1 sh -c "update-ca-certificates"
sudo docker exec -it src_h13_1 sh -c "dpkg-reconfigure ca-certificates"
#Yes
#Certificates: 1
sudo docker exec -it src_h13_1 sh -c "curl https://strapi.sergiomartin.tp7"
